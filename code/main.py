...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("Dynamic center detection enabled.")
            ...
            while True:
                ...
                angle, tip, center = find_needle_angle(frame, calib_data, hough_params)
                
                if center is not None:
                    # Рисуем опорную ось относительно найденного центра
                    draw_reference_axis(frame, center, calib_data['radius'])
                else:
                    cv2.putText(frame, "Center not found", (10, 60),
                                cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0,0,255), 1)
                
                if angle is not None and tip is not None:
            ...
            if angle is not None and tip is not None:
                ...
                print("Needle not found or center not detected")
        elif choice == "7":
            print("Goodbye!")
            break
        else:
